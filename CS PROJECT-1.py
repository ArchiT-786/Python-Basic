...
while passw=='admin':
    ...
    mycon=mys.connect(host="localhost",user="root",password="admin")
    mycursor=mycon.cursor()
    mycursor.execute("create database my_hospital")
    mycursor.execute("use my_hospital")
    mycursor.execute("create table patients(Name varchar(30) primary key not null,Sex varchar(3),Age int(3),Address varchar(50),Contact int(30),Doctor varchar(30))")
    mycursor.execute("create table doctors(Name varchar(30) primary key,Specialisation varchar(40),Age int(2),address varchar(30),Contact varchar(15),Fees int(10),Monthly_salary int(10))")
    mycursor.execute("create table nurses(Name varchar(30) primary key,Age int(2),Address varchar(30),Contact varchar(15),Monthly_salary int(10))")
    mycursor.execute("create table other_workers(Name varchar(30) primary key,Age int(2),Address varchar(30),Contact varchar(15),Monthly_salary int(10))")
                        ...
                        if c==1:
                            ...
                            if c1==1:
                                ...
                                if c4==1:
                                    ...
                                    name=input("ENTER NURSE NAME: ")
                                    query9="select*nurses where name='{0}'".format(name)
                            ...
                            if b==1:
                                ...
                                for i in row:
                                    ...
                                    d={y[0]:i[0],y[1]:i[1],y[2]:i[2],y[3]:i[3],y[4]:i[4],y[5]:i[5]}
                                    print(d)
                            elif b==2:
