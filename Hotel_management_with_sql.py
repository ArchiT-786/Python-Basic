...
mycursor.execute('create table hotel(NAME varchar(100),PHNO varchar(30),ROOMNO integer,ADDRESS varchar(200),DAYS integer,CHECKIN date,CHECKOUT date,PAYMENT_MODE varchar(100),BILL integer,C_ID integer(100),PRIMARY KEY(C_ID))')
...
def Booking():
    ...
    if n==0:
        ...
        exit()
    quary="insert into hotel values('{0}','{1}',{2},'{3}',{4},{5})".format(NAME,PHNO,ROOMNO,ADDRESS,DAYS,C_ID)
